  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 flex flex-col">
      ...
      <main className="flex-1 p-6">
        <div className="bg-white shadow-xl rounded-lg p-6 mb-6 border-t-4 border-blue-500 transition-transform transform hover:scale-105 duration-300 ease-in-out">
          <TimeSelector timeFrame={timeFrame} onChange={handleTimeChange} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white shadow-xl rounded-lg p-6 border-t-4 border-green-500 transition-transform transform hover:scale-105 duration-300 ease-in-out">
            <StatsContainer timeFrame={timeFrame} />
          </div>
          <div className="bg-white shadow-xl rounded-lg p-6 col-span-2 border-t-4 border-yellow-500 transition-transform transform hover:scale-105 duration-300 ease-in-out">
